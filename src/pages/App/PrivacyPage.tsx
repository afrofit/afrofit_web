...
const PrivacyPage: React.FC<Props> = () => {
  ...
  const subtitleStyle = { color: COLORS.whiteblue, fontSize: 22, mb: 3 };
  ...
  const bigParagraphStyle = { color: COLORS.whiteblue, fontSize: 18, mb: 3 };

  const paragraphStyle = { color: COLORS.whiteblue, fontSize: 16, mb: 3 };

  return (
    <PageLayout title="Privacy Policy">
      <Typography sx={bigParagraphStyle}>
        Last updated: September 06, 2022 This Privacy Policy describes Our
      ...
      <Typography sx={titleStyle}>Interpretation and Definitions</Typography>
      <Typography sx={subtitleStyle}>Interpretation</Typography>
      ...
      <Typography sx={subtitleStyle}>Definitions</Typography>
      <Typography sx={paragraphStyle}>
      ...
      <Typography sx={paragraphStyle}>
        ...
        the Company downloaded by You on any electronic device, named Afrofit
        App • Company (referred to as either "the Company", "We", "Us" or "Our"
        in this Agreement) refers to Afrofitapp Limited, 71-75 Shelton Street,
        London, Greater London, United Kingdom, WC2H 9JQ.
      </Typography>
      <Typography sx={paragraphStyle}>
      ...
      <Typography sx={paragraphStyle}>
        • <strong>Country</strong> refers to: United Kingdom • Device means any
      ...
      <Typography sx={paragraphStyle}>
        ...
        Website refers to Afrofit Fitness Club, accessible from
        https://afrofitapp.com
      </Typography>
      <Typography sx={paragraphStyle}>
      ...
      <Typography sx={subtitleStyle}>Types of Data Collected</Typography>
      <Typography sx={subtitleStyle2}>Personal Data</Typography>
      <Typography sx={paragraphStyle}>
      ...
      <Typography sx={paragraphStyle}>• Email address</Typography>
      <Typography sx={paragraphStyle}>• First name and last name</Typography>
      <Typography sx={paragraphStyle}>• Usage Data</Typography>
      <Typography sx={subtitleStyle2}>Usage Data</Typography>
      <Typography sx={paragraphStyle}>
      ...
      <Typography sx={paragraphStyle}>
        ...
        <a style={{ color: COLORS.fuschia }} href={policyGenLink}>
      ...
      <Typography sx={paragraphStyle}>
        <strong>• Necessary / Essential Cookies Type:</strong> Session Cookies
      ...
      <Typography sx={subtitleStyle2}>Use of Your Personal Data</Typography>
      <Typography sx={paragraphStyle}>
      ...
      <Typography sx={subtitleStyle}>Transfer of Your Personal Data</Typography>
      <Typography sx={paragraphStyle}>
      ...
      <Typography sx={subtitleStyle2}>Business Transactions</Typography>
      <Typography sx={paragraphStyle}>
      ...
      <Typography sx={subtitleStyle2}>Law enforcement</Typography>
      <Typography sx={paragraphStyle}>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </Typography>
      <Typography sx={subtitleStyle2}>Other legal requirements</Typography>
      <Typography sx={paragraphStyle}>
      ...
      <Typography sx={titleStyle}>Children's Privacy</Typography>
      <Typography sx={paragraphStyle}>
      ...
      <Typography sx={titleStyle}>Links to Other Websites</Typography>
      <Typography sx={paragraphStyle}>
      ...
      <Typography sx={titleStyle}>Changes to this Privacy Policy</Typography>
      <Typography sx={paragraphStyle}>
      ...
      <Typography sx={paragraphStyle}>
        • By email: info@afrofitapp.com
      </Typography>
      <Typography sx={paragraphStyle}>
        • By visiting this page on our website: afrofitapp.com/contact
      </Typography>
    </PageLayout>
  );
};
